...
hf download bartowski/Qwen2.5.1-Coder-7B-Instruct-GGUF Qwen2.5.1-Coder-7B-Instruct-Q4_K_M.gguf --local-dir ~/models/fast

# Qwen3.5-9B model
# https://huggingface.co/bartowski/Qwen_Qwen3.5-9B-GGUF

hf download bartowski/Qwen_Qwen3.5-9B-GGUF --dry-run
hf download bartowski/Qwen_Qwen3.5-9B-GGUF Qwen_Qwen3.5-9B-Q4_K_L.gguf  --local-dir ~/models/fast

# Llama 3.1 8B Instruct
# https://huggingface.co/bartowski/Meta-Llama-3.1-8B-Instruct-GGUF

hf download bartowski/Meta-Llama-3.1-8B-Instruct-GGUF --dry-run
hf download bartowski/Meta-Llama-3.1-8B-Instruct-GGUF Meta-Llama-3.1-8B-Instruct-Q4_K_M.gguf --local-dir ~/models/fast
...
hf download bartowski/google_gemma-3n-E4B-it-GGUF google_gemma-3n-E4B-it-Q4_K_M.gguf --local-dir ~/models/fast
...
hf download mistralai/Ministral-3-8B-Instruct-2512-GGUF Ministral-3-8B-Instruct-2512-Q4_K_M.gguf  --local-dir ~/models/fast