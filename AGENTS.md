...
Aider benchmark with a reproducible subset (`--aider-limit` + `--aider-test-seed`):
`sh benchmark-perf.sh models/models1.txt --run-aider --aider-limit 10 --aider-test-seed 1234`
