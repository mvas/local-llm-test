...
hf download Qwen/Qwen2.5-Coder-14B-Instruct-GGUF qwen2.5-coder-14b-instruct-q4_k_m.gguf  --local-dir ~/models
...
hf download unsloth/gemma-3-12b-it-GGUF gemma-3-12b-it-Q4_K_M.gguf --local-dir ~/models

# Devstral Small 1.1
# https://huggingface.co/mistralai/Devstral-Small-2507_gguf
hf download mistralai/Devstral-Small-2507_gguf --dry-run
hf download mistralai/Devstral-Small-2507_gguf Devstral-Small-2507-Q4_K_M.gguf --local-dir ~/models
...
hf download mistralai/Ministral-3-14B-Instruct-2512-GGUF Ministral-3-14B-Instruct-2512-Q4_K_M.gguf --local-dir ~/models